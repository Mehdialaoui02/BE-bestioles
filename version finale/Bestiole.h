...
protected :
   ...
   double            oreille_detection; // gamma oreille
   double            oreille_distance_coef;

   double            yeux_detection; // gamma yeux
   double            yeux_distance_coef;
   double            yeux_angle;
...
public :                                           // Forme canonique :
   ...
   int getCoefCarapace( void ){return coef_carapace;};
   double getCamouflageCoef( void ){return camouflage_coef;};
